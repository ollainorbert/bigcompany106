...
class EmployeeInfoCsvFileReaderTest {
    ...
    private static final List<Employee> EXPECTED_EMPLOYEES = List.of(
        new Employee(123, "Joe", "Doe", BigDecimal.valueOf(60000), null),
    ...
    @Test
    void readErrorDueIoExceptionTest() {
        String fileName = "src/test/resources/malformed.csv";
        ...
        assertEquals(String.format(ERROR_WHILE_READING_PATTERN, fileName), thrown.getMessage());
    }
